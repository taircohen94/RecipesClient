<template>
  <div class="container">
    <br />
    <h1 style="text-align:centerl; color:white;">Register</h1>
    <br />
    <b-form @submit.prevent="onRegister" @reset.prevent="onReset">
      ...
      >
        ...
        >With length between 5-10 characters long</b-form-invalid-feedback>
        <b-form-invalid-feedback
          v-if="$v.form.password.required && !$v.form.password.containsNumber"
        >Contains at least one number</b-form-invalid-feedback>
        <b-form-invalid-feedback
          v-if="$v.form.password.required && !$v.form.password.containsSpecialChar"
        >Contains at least one special charachter</b-form-invalid-feedback>
      </b-form-group>
      ...
      <b-form-group id="input-group-username" label-cols-sm="3" label="email:" label-for="email">
        <b-form-input
          id="email"
        ...
        ></b-form-input>
        <b-form-invalid-feedback v-if="!$v.form.firstName.required">Email is required</b-form-invalid-feedback>
        <b-form-invalid-feedback v-if="!$v.form.email.email">Email must be in a correct form</b-form-invalid-feedback>
      </b-form-group>
      ...
      >
        ...
        ></b-form-input>
        <b-form-invalid-feedback v-if="!$v.form.image.required">Profile picture is required</b-form-invalid-feedback>
      </b-form-group>
